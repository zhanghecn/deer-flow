...
export const enUS: Translations = {
  ...
  settings: {
    ...
    memory: {
      title: "Memory",
      description:
        "OpenAgents automatically learns from your conversations in the background. These memories help OpenAgents understand you better and deliver a more personalized experience.",
