...
export const enUS: Translations = {
  ...
  toolCalls: {
    ...
    clarificationQuestion: "Clarification needed",
    clarificationContext: "Why this is needed",
    clarificationOptions: "Options",
    clarificationReplyPlaceholder: "Type your answer",
    clarificationReplyAction: "Send answer",
    clarificationResumeError: "Failed to continue the clarification flow.",
