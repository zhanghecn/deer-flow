...
export interface Translations {
  ...
  knowledge: {
    ...
    openSourcePreview: string;
    loadingWorkspace: string;
    emptyWorkspace: string;
    workspaceDefaultTitle: string;
    loadingWorkspaceFile: string;
    selectWorkspaceFile: string;
    loadingGraph: string;
    emptyGraph: string;
    graphNodeCount: (count: number) => string;
    graphCommunity: (community: number) => string;
    graphLinks: (count: number) => string;
    graphEdges: string;
    ...
    graphSparseCommunities: (count: number) => string;
    graphRenderedEdges: (rendered: number, total: number) => string;
    graphNodeVisibleCount: (visible: number, total: number) => string;
    graphFilter: string;
    graphFilters: string;
    graphReset: string;
    ...
    graphNoVisibleNodes: string;
    graphHideThisNode: string;
    graphShowAll: string;
    graphRelevance: string;
    graphIsolatedInsight: string;
    graphSparseCommunityTitle: (name: string) => string;
    graphSparseCommunityDescription: (nodeCount: number, cohesion: number) => string;
    graphNoInsights: string;
