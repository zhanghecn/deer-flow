...
export const zhCN: Translations = {
  ...
  // Commands
  commands: {
    knowledgeAdd: "把本次上传文件准备为当前线程知识库并允许 agent 检索",
  ...
  knowledge: {
    ...
    defaultBaseName: "知识库",
    preparationQueued: "知识库原文准备任务已加入队列。",
    createError: "创建知识库失败。",
    uploadButton: "上传知识库",
    newTitle: "新建知识库",
    newDescription:
    ...
    uploadNextStepThread:
      "上传后，可在聊天里的已挂载知识区打开详情并持续查看原文准备进度。",
    uploadNextStepLibrary:
      "上传后，可在知识库列表中打开对应条目，查看原文准备进度和原文工作区。",
    managerTitle: "知识库管理",
    managerDescription:
      "按用户浏览共享知识库，查看处理进度，并审查原文资料文件。",
    managerTitleGlobal: "共享知识库",
    managerDescriptionGlobal:
      "按用户文件夹浏览共享知识库，查看处理进度，并审查原文文件、知识图谱和原文。",
    libraryTitle: "共享知识库",
    libraryDescription:
      "知识库按所属用户分组。将知识库挂载到当前线程后，agent 工具才能直接检索它。",
    libraryDescriptionGlobal:
      "知识库按所属用户分组，方便直接检查共享文档、预览源文件，并审查原文工作区产物。",
    ...
    noDocumentSelectedDescription:
      "从左侧选择一个文档，以查看构建状态、canonical 原文和来源预览。",
    sourcesTab: "资料",
    sourceWorkspaceTab: "原文工作区",
    knowledgeGraphTab: "知识图谱",
    workspaceFiles: "工作区文件",
    sourceDocuments: "来源文档",
    openSourcePreview: "预览",
    loadingWorkspace: "正在加载工作区...",
    emptyWorkspace: "暂时没有工作区文件。",
    workspaceDefaultTitle: "原文工作区",
    loadingWorkspaceFile: "正在加载文件...",
    selectWorkspaceFile: "请选择一个工作区文件。",
    loadingGraph: "正在加载知识图谱...",
    emptyGraph: "暂时没有图谱节点。",
    graphNodeCount: (count: number) => `${count} 个图谱节点`,
    graphCommunity: (community: number) => `社区 ${community}`,
    graphLinks: (count: number) => `${count} 条连接`,
    graphEdges: "关系边",
    graphSelectedNode: "选中节点",
    graphNoNodeSelected: "点击图谱节点后查看路径和关系。",
    graphOpenSource: "打开来源文件",
    graphCommunities: "社区",
    graphInsights: "图谱洞察",
    graphIsolatedNodes: (count: number) => `${count} 个孤立节点`,
    graphSparseCommunities: (count: number) => `${count} 个稀疏社区`,
    graphRenderedEdges: (rendered: number, total: number) =>
      `已渲染 ${rendered} / ${total} 条关系`,
    ...
    graphReset: "重置",
    graphTypeMode: "类型",
    graphCommunityMode: "社区",
    graphHideIsolated: "隐藏孤立节点",
    graphMaxLinks: "最大连接数",
    graphAnyLinks: "不限",
    graphNodeTypes: "节点类型",
    graphNoVisibleNodes: "当前过滤条件下没有可见图谱节点。",
    graphHideThisNode: "隐藏此节点",
    graphShowAll: "显示全部",
    graphRelevance: "相关度",
    graphIsolatedInsight: "这个页面连接较少，建议补充交叉引用或检查来源覆盖。",
    graphSparseCommunityTitle: (name: string) => `稀疏社区：${name}`,
    graphSparseCommunityDescription: (nodeCount: number, cohesion: number) =>
      `${nodeCount} 个页面，凝聚度 ${cohesion.toFixed(2)}，内部连接偏弱。`,
    graphNoInsights: "暂无可用图谱洞察。",
    ...
    processingCount: (count: number) => `${count} 个准备中`,
    ...
    previewSetting: "预览权限",
    previewSettingHint: "允许其他用户打开来源文件和 canonical 原文预览。",
    ...
    deleteDescription: (name: string) =>
      `确定删除“${name}”及其全部已准备原文文档吗？此操作不可撤销。`,
    deleteSuccess: (name: string) => `已删除“${name}”。`,
    deleteError: "删除知识库失败。",
    clearAllTitle: "清空知识库",
    clearAllSelfDescription: (count: number) =>
      `确定清空你自己的全部 ${count} 个知识库吗？其原文工作区、canonical 原文、源文件和预览文件都会被删除，此操作不可撤销。`,
    clearAllOwnerDescription: (ownerName: string, count: number) =>
      `确定清空“${ownerName}”名下的全部 ${count} 个知识库吗？其原文工作区、canonical 原文、源文件和预览文件都会被删除，此操作不可撤销。`,
    ...
    buildProgressDescription: "查看选中文档的原文准备阶段、耗时和最新任务状态。",
    stageLabel: "阶段",
    progressLabel: "进度",
    elapsedLabel: "耗时",
    updatedAtLabel: "更新时间",
