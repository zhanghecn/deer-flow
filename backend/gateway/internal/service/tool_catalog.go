...
var builtinToolCatalog = []model.ToolCatalogItem{
	...
	},
	{
		...
		Group:                    "knowledge",
		Label:                    "Search Knowledge Workspace",
		Description:              "Search generated wiki pages across attached knowledge workspaces.",
		ConfigurableForMainAgent: true,
		ConfigurableForSubagent:  true,
		ReservedPolicy:           "normal",
		Source:                   "builtin",
	},
	{
		...
		Group:                    "knowledge",
		Label:                    "Get Wiki Page",
		Description:              "Read a generated wiki page from an attached knowledge workspace.",
		ConfigurableForMainAgent: true,
		ConfigurableForSubagent:  true,
		ReservedPolicy:           "normal",
		Source:                   "builtin",
	},
	{
		...
		Group:                    "knowledge",
		Label:                    "Get Source Evidence",
		Description:              "Fetch bounded original-source snippets from a knowledge workspace raw cache.",
		ConfigurableForMainAgent: true,
		ConfigurableForSubagent:  true,
		ReservedPolicy:           "normal",
		Source:                   "builtin",
	},
	{
		...
		Description:              "Inspect wiki graph nodes, edges, communities, and structural insights.",
		ConfigurableForMainAgent: true,
		ConfigurableForSubagent:  true,
		ReservedPolicy:           "normal",
		Source:                   "builtin",
	},
	{
		...
		Group:                    "knowledge",
		Label:                    "Get Workspace File Tree",
		Description:              "List files in attached llm-wiki style knowledge workspaces.",
		ConfigurableForMainAgent: true,
		ConfigurableForSubagent:  true,
		ReservedPolicy:           "normal",
		Source:                   "builtin",
