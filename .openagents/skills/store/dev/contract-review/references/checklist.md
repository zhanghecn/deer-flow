...
- [ ] Renewal / extension mechanism does not auto-renew or permit unilateral repricing without clear consent
...
- [ ] Currency is clear
- [ ] Price escalation / adjustment mechanism is objective, bounded, and not left to unilateral discretion
...
- [ ] Deposit / retention refund conditions and timing are objective and not overbroad
...
- [ ] Maintenance / repair obligations are allocated to the appropriate party and do not shift owner-side or structural duties wholesale
...
### Knowledge-Base Mode B Coverage
- Do not stop after a few representative issues. Walk the relevant checklist categories and make coverage explicit in the visible answer/report.
- If a category is absent from the reviewed text, say it was **not found in the reviewed text** instead of inferring it.
- If the contract is a blank template or model form, review **prefilled default clauses** separately from **blank fields**.
- If the contract is a blank template or model form, do not promote an absent clause category into a standalone Layer 1-3 risk finding unless the clause language itself appears in evidence.
