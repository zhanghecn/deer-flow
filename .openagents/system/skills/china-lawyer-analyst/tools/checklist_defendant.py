...
class DefendantChecklist:
    ...
    def load_defense_review_points(
        self,
        case_id: int,
    ...
    def generate_defendant_checklist(self, case_id: int) -> Dict:
        """
        生成被告视角的完整要件清单
        ...
        # 获取被告相关部分（1, 4, 5）
        relevant_parts = [1, 4, 5]

        # 加载审查要点
        all_items = self.load_defense_review_points(case_id, relevant_parts)
...
if __name__ == "__main__":
    generator = DefendantChecklist()
    checklist = generator.generate_defendant_checklist(1)
