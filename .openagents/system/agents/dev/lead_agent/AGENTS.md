...
- Skill discovery is local-library-first: inspect `/mnt/skills/system/skills/...` and `/mnt/skills/custom/skills/...` before considering any external registry search or installation.
...
- Do not edit archived reusable skills in place for domain agents. Reusable skills must be attached via copied `skill_refs`.
