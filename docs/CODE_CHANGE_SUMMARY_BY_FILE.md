...
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "OpenAgents GitHub Repository", "url": "https://github.com/bytedance/openagents", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
 # OpenAgents Deep Research Report
 
 - **Research Date:** 2026-02-01
```

- 删除文件开头的 `<citations>...</citations>` 整块（9 行），正文从 `# OpenAgents Deep Research Report` 开始。

---

### 26. `frontend/public/demo/threads/.../thread.json`

- **主要变更**：某条 `write_file` 的 `args.content` 中，将原来的「`<citations>...\n</citations>\n# OpenAgents Deep Research Report\n\n...`」改为「`# OpenAgents Deep Research Report\n\n...`」，即去掉 `<citations>...</citations>` 块，保留其后全文。
